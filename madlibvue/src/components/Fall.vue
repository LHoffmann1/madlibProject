<template>
  <div class="form">
    <!-- <form class="winter" v-bind:style="{'display': (this.isHidden? 'none': 'inline-block')}"> -->
        <form id = "fall" v-on:submit.prevent="toggleClass">
      <h2 id="form-directions">
        Fill in the parts of speech to <br />
        complete the Fall Madlib!
      </h2>
      ...
      <div class="form-group">
        <button type="submit" class="submit" id="submit-fall">
          Submit Words
        </button>
      </div>
    </form>
