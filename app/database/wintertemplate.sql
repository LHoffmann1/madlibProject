...
INSERT INTO madlibs (madlib_id, madlib_string1, madlib_string2, madlib_string3, madlib_string4, madlib_string5, madlib_string6, madlib_string7)
        ...
        ('fall', 'My friend and I ',' leaves into a gigantic ' , '. It is a swirl of red, yellow, and orange. So ','! All of a sudden, my ', ' bounds across the yard and pounces into the pile. ', ' go everywhere as he climbs out, his tail ', '. We drop our rakes, laughing, and head aross the yard to throw the ');
